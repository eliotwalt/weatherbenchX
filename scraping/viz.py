...
FILENAMES = {
    "probabilistic": {
        "FGN (oper.) vs Analysis": "fgn_hres_init_vs_hres_t0_1440x721_2022.nc",
        "FGN (oper.) vs ERA5": "fgn_hres_init_vs_era5_1440x721_2022.nc",
        "GenCast (oper.) vs Analysis": "gencast_hres_init_vs_hres_t0_1440x721_2022.nc",
        "GenCast (oper.) vs ERA5": "gencast_hres_init_vs_era5_1440x721_2022.nc",
        "IFS ENS vs Analysis": "ifs_ens_vs_hres_t0_1440x721_2022.nc",
        "IFS ENS vs ERA5": "ifs_ens_vs_era5_1440x721_2022.nc",
    },
    "deterministic": {
        "Aurora (oper.) vs Analysis": "aurora_hres_init_vs_hres_t0_1440x721_2022.nc",
        # "FGN (oper.) (1st member) vs Analysis": "fgn_hres_init_first_member_vs_hres_t0_1440x721_2022.nc",
        # "FGN (oper.) (1st member) vs ERA5": "fgn_hres_init_first_member_vs_era5_1440x721_2022.nc",
        "FGN (oper.) (mean) vs Analysis": "fgn_hres_init_mean_vs_hres_t0_1440x721_2022.nc",
        "FGN (oper.) (mean) vs ERA5": "fgn_hres_init_mean_vs_era5_1440x721_2022.nc",
        # "GenCast (oper.) (1st member) vs Analysis": "gencast_hres_init_first_member_vs_hres_t0_1440x721_2022.nc",
        # "GenCast (oper.) (1st member) vs ERA5": "gencast_hres_init_first_member_vs_era5_1440x721_2022.nc",
        "GenCast (oper.) (mean) vs Analysis": "gencast_hres_init_mean_vs_hres_t0_1440x721_2022.nc",
        "GenCast (oper.) (mean) vs ERA5": "gencast_hres_init_mean_vs_era5_1440x721_2022.nc",
        "GraphCast (oper.) vs Analysis": "graphcast_hres_init_vs_hres_t0_1440x721_2022.nc",
        "GraphCast (oper.) vs ERA5": "graphcast_hres_init_vs_era5_1440x721_2022.nc",
        ...
        # "Pangu-Weather (oper.) vs Analysis": "pangu_weather_hres_init_vs_hres_t0_1440x721_2022.nc",
        # "Pangu-Weather (oper.) vs ERA5": "pangu_weather_hres_init_vs_era5_1440x721_2022.nc",
